...
contract Comptroller is ComptrollerV7Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    constructor(address _compAddress) {
        admin = msg.sender;
        address compAddress = _compAddress;
    }
     ...
     * @return compAddress The address of COMP
     */
    function getCompAddress() virtual public view returns (address compAddress) {
        return compAddress;
    }
}
